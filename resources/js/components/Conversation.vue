    ...
    <div v-else-if="conversation">
        ...
        <div class="media" v-for="reply in conversation.replies.data">
            <div class="media-left">
                <img v-bind:src="reply.user.data.avatar">
            </div>
         ...
         <div class="media">
            <div class="media-left col-sm-2">
                   <img v-bind:src="conversation.user.data.avatar">
            </div>
             <div class="media-body">
...
import ConversationReplyForm from "./forms/ConversationReplyForm";
import ConversationAddUserForm from "./forms/ConversationAddUserForm";
export default {
    name: "Conversation",
    components: {ConversationAddUserForm, ConversationReplyForm},
    props:[
        'id'
    ],
